...
def parsehtmltoDataFrame(txt):
    ...
    cardata['year'] = [(int(a.lstrip().split(" ")[0])) for a in vehtitle]
...
if __name__ == "__main__":
    ...
    comment = "kluger"
    url_kluger = "https://www.carsales.com.au/cars/bmw/2-series/convertible-bodystyle/"
